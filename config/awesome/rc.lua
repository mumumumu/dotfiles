...
beautiful.init("/usr/share/awesome/themes/cirno/theme.lua")
...
tags = {
    names = {"main", "www", "vbox", "media", "c", "i", "r", "n", "⑨"},
    layout = { layouts[3], layouts[4], layouts[11], layouts[11], layouts[1],
...
vicious.register( batwidget, vicious.widgets.bat, "$3", 1, "BAT0" )
...
line:set_markup("<span color='#4682b4'>|</span>")
...
for s = 1, screen.count() do
    ...
    right_layout:add(space)
    right_layout:add(batbar_with_margin)
    right_layout:add(space)
    right_layout:add(space)
